...
PACKAGENAME=bzip2
VERSION="1.0.6"
SOURCEURL=http://www.bzip.org/${VERSION}/${PACKAGENAME}-${VERSION}.tar.gz
...
make clean
make
make PREFIX=${BUILDDIR}/ffp install
...
install -m755 libbz2.so.1.0.6 ${BUILDDIR}/ffp/lib
ln -s libbz2.so.1.0.6 ${BUILDDIR}/ffp/lib/libbz2.so
ln -s libbz2.so.1.0.6 ${BUILDDIR}/ffp/lib/libbz2.so.1
ln -s libbz2.so.1.0.6 ${BUILDDIR}/ffp/lib/libbz2.so.1.0
