...
make SYS=posix OPT="$CFLAGS" XLDFLAGS="$LDFLAGS" CRYPTO="GNUTLS" prefix=/ffp
make prefix=/ffp sbindir=/ffp/bin mandir=/ffp/share/man CRYPTO="GNUTLS" DESTDIR=${BUILDDIR} install
